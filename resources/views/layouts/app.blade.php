...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-115970352-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-115970352-1');
    </script>
</head>
<body>
    <div id="fb-root"></div>
        <script class="ce-script">(function(d, s, id) {
                    var js, fjs = d.getElementsByTagName(s)[0];
                    if (d.getElementById(id)) return;
                    js = d.createElement(s); js.id = id;
                    js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.11&appId=152452958776176';
