...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <small>Won</small>
            <h2><?php echo e($team->won); ?></h2>
        </div>
        <div class="col-md-4">
            <small>Played</small>
            <h2><?php echo e($team->played); ?></h2>
        </div>
        <div class="col-md-4">
            <small>Rank</small>
            <h2><?php echo e($team->won > 0 ? number_format($team->played / $team->won * 100, 2) : 0); ?>%</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="text-center">
                                        <a href="<?php echo e(route('play', ['id' => $team->id ])); ?>" class="btn btn-primary">Play</a>
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
